...
const analyticsBlocks: Record<string, string> = {
...
Facebook Analytics is a web analytics service. Facebook uses the data collected to track and monitor the use of our Service. Facebook may use the collected data to contextualize and personalize the ads of its own advertising network.

For more information about Facebook Analytics, please visit their Privacy Policy: https://www.facebook.com/privacy/explanation`,

  "Firebase": `Firebase

Firebase is an app development platform provided by Google. For more information on the privacy practices of Firebase, please visit the Firebase Privacy Policy: https://firebase.google.com/support/privacy`,

  "Matomo": `Matomo

Matomo is a web analytics service. Matomo uses the data collected to track and monitor the use of our Service. For more information on the privacy practices of Matomo, please visit their Privacy Policy: https://matomo.org/privacy-policy/`,

  "Clicky": `Clicky

Clicky is a web analytics service. Clicky uses the data collected to track and monitor the use of our Service. For more information, please visit their Privacy Policy: https://clicky.com/terms/privacy`,

  "Statcounter": `Statcounter

Statcounter is a web analytics service. Statcounter uses the data collected to track and monitor the use of our Service. For more information, please visit their Privacy Policy: https://statcounter.com/about/legal/`,

  "Flurry Analytics": `Flurry Analytics

Flurry Analytics is provided by Yahoo. For more information on the privacy practices of Flurry Analytics, please visit their Privacy Policy: https://policies.oath.com/us/en/oath/privacy/products/developer/index.html`,

  "Mixpanel": `Mixpanel

Mixpanel is provided by Mixpanel Inc. For more information on the privacy practices of Mixpanel, please visit their Privacy Policy: https://mixpanel.com/legal/privacy-policy/`,

  "Unity Analytics": `Unity Analytics

Unity Analytics is provided by Unity Technologies. For more information on the privacy practices of Unity Analytics, please visit their Privacy Policy: https://unity3d.com/legal/privacy-policy`,
};
...
export function generatePrivacyPolicy(data: PolicyFormData): string {
  ...
  const contactList = data.contactMethodsPP
    .map((method) => `- ${method}`)
    .join("\n");
...
We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.`;
  ...
  const definitionsSection = `Interpretation and Definitions
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ${data.websiteName}.
...
Country refers to: ${data.state}, ${data.country}
...
Under GDPR, You can be referred to as the Data Subject or as the User as you are the individual using the Service.`;
  ...
  // --- Collecting Data ---
  const collectingDataSection = `Collecting and Using Your Personal Data
...
We may also collect information that Your browser sends whenever You visit Our Service or when You access the Service by or through a mobile device.`;
  ...
  // --- Cookies ---
  const cookiesSection = `Tracking Technologies and Cookies
...
For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.`;
  ...
  // --- Use of Data ---
  const useOfDataSection = `Use of Your Personal Data
...
With Your consent: We may disclose Your personal information for any other purpose with Your consent.`;
  ...
  // --- Retention ---
  const retentionSection = `Retention of Your Personal Data
...
The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer periods.`;
  ...
  // --- Transfer ---
  const transferSection = `Transfer of Your Personal Data
...
The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.`;
  ...
  // --- Delete ---
  const deleteSection = `Delete Your Personal Data
...
Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.`;
  ...
  // --- Disclosure ---
  const disclosureSection = `Disclosure of Your Personal Data
...
- Protect against legal liability`;
  ...
  // --- Security ---
  const securitySection = `Security of Your Personal Data

The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially reasonable means to protect Your Personal Data, We cannot guarantee its absolute security.`;

  // --- Analytics ---
  let analyticsSection = "";
  if (data.usesAnalytics && data.analyticsTools.length > 0) {
    const toolBlocks = data.analyticsTools
      .map((tool) => analyticsBlocks[tool] || "")
      .filter(Boolean)
      .join("\n\n");

    analyticsSection = `Detailed Information on the Processing of Your Personal Data
...
You have the right to complain to a Data Protection Authority about Our collection and use of Your Personal Data. For more information, if You are in the European Economic Area (EEA), please contact Your local data protection authority in the EEA.`;
  ...
  let ccpaSection = "";
  if (data.includeCCPA) {
    ccpaSection = `CCPA/CPRA Privacy Notice (California Privacy Rights)
...
We collect, use and disclose sensitive personal information in ways that are necessary to provide the Service. For more information on how We use Your personal information, please see the "Use of Your Personal Data" section or contact us.`;
  ...
  // --- CalOPPA ---
  let calOppaSection = "";
  if (data.includeCalOPPA) {
    calOppaSection = `"Do Not Track" Policy as Required by California Online Privacy Protection Act (CalOPPA)
...
However, some third-party websites do keep track of Your browsing activities. If You are visiting such websites, You can set Your preferences in Your web browser to inform websites that You do not want to be tracked. You can enable or disable DNT by visiting the preferences or settings page of Your web browser.`;
  ...
  // --- Children ---
  const childrenSection = `Children's Privacy
...
If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.`;
  ...
  // --- Links ---
  const linksSection = `Links to Other Websites
...
We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.`;
  ...
  // --- Changes ---
  const changesSection = `Changes to this Privacy Policy
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.`;
  ...
  // --- Contact ---
  const contactSection = `Contact Us
