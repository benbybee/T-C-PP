# Privacy Policy Reference Template

This is the reference text used to build the privacy policy generator template.
...
Country refers to: [country], [state]
...
Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ. Code SS 1798.80(e)).
...
The Service Providers we partner with (for example, our analytics or advertising partners) may use technology on the Service that sells personal information as defined by the CCPA/CPRA law.
